...
def generate_page3(excel_file, template_file, output_file, current_image=None, old_image=None, field_data=None):
    ...
    # Make sure to use the correct paths for both old and current NDMI images
    old_image_path = 'images/old_ndmi.png'  # Use a fixed path to ensure it's always available
    current_image_path = 'images/current_ndmi.png'
