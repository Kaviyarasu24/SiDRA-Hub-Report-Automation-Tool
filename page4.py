...
def generate_page4(excel_file, template_file, output_file, current_image=None, old_image=None, field_data=None):
    ...
    # Make sure to use the correct paths for both old and current RECI images
    old_image_path = 'images/old_reci.png'  # Use a fixed path to ensure it's always available
    current_image_path = 'images/current_reci.png'
